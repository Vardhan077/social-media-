      ...
      <div className="flex flex-col py-4 bg-white rounded-t-3xl">
        <div className="flex justify-start items-center pb-4 pl-4 ">
          ...
          <div className="flex flex-col ml-4">
            ...
            <span className=" font-roboto font-medium text-gray-700 no-underline tracking-normal leading-none" style={{fontSize:"10px"}}>
              Published: {timestamp}
            </span>
          </div>
          {user?.uid !== uid && (
        ...
        <div>
          <p className="ml-4 pb-4 font-roboto font-medium text-sm text-gray-700 no-underline tracking-normal leading-none" style={{fontSize:"20px",marginLeft:'30px',marginTop:"15px"}}>
            {text}
          </p>
          {image && (
